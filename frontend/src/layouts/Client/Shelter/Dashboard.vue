<template>
    <div>
                ...
                <div class="fixed inset-0 flex">
                    <TransitionChild as="template" enter="transition ease-in-out duration-300 transform"
                        ...
                        <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
                            ...
                            <div
                                class="flex grow flex-col gap-y-5 overflow-y-auto bgorange px-6 pb-4 ring-1 ring-white/10">
                                <div class="flex h-16 shrink-0 items-center">
                                    <img :src="logo" alt="logo Icon" class="w-10" aria-hidden="true"/>
                                    <span class="pl-3 font-bold text-2xl text-white">FurrySafe</span>
                                </div>
                                        ...
                                        <li>
                                            <ul role="list" class="-mx-2 space-y-1">
                                                <li v-for="item in navigation" :key="item.name">
                                                    <router-link v-if="!item.children" :to="item.to" :class="[item.current ? ' bgdarkorange text-white' : 'text-white hover:text-white hover:bg-darkorange', 'group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold']">
        ...
        <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
            <!-- Sidebar component, swap this element with another sidebar if you like -->
            <div class="flex grow flex-col gap-y-5 overflow-y-auto bgorange pb-4">
...
import shelterICON from '@/assets/images/Footprint.png'
import dashboardICON from '@/assets/images/Dashboard Layout.png'
import logoutICON from '@/assets/images/Logout.png'
import petsICON from '@/assets/images/pethome.png'
import myshelterICON from '@/assets/images/MyShelter.png'
import pawICON from '@/assets/images/AnimalProfile.png'
